node{
    ...
    stage('Build Docker Image'){
         sh 'docker build -t rajnikhattarrsinha/dockerpipelinedemo0802:2.0.0 .'
      }  
      ...
      stage('Publish Docker Image'){
        ...
        sh 'docker push rajnikhattarrsinha/dockerpipelinedemo0802:2.0.0'
      }
   ...
   stage('Pull Docker Image and Deploy'){        
            ...
            def dockerRun= "sudo docker run -p 8080:8080 -d --name ${dockerContainerName} rajnikhattarrsinha/dockerpipelinedemo0802:2.0.0"         
           //sshagent(['dockerdeployserver2']) {
        // sshagent(['dockergcpserver']) {
              sshagent(['tomcatdeploymentserver']) {   
