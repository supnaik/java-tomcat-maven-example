node{
    ...
    stage('Build Docker Image'){
         sh 'docker build -t rajnikhattarr/javatomcat1reliancedemo20:2.0.0 .'
      }  
      ...
      stage('Publish Docker Image'){
        ...
        sh 'docker push rajnikhattarr/javatomcat1reliancedemo20:2.0.0'
      }
   ...
   stage('Pull Docker Image and Deploy'){        
            ...
            def dockerRun= "sudo docker run -p 8080:8080 -d --name ${dockerContainerName} rajnikhattarr/javatomcat1reliancedemo20:2.0.0"         
            sshagent(['dockerdeployserver2']) {
